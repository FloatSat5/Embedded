...
namespace lnz
{
    ...
    inline Matrix<3, 3> Matrix<3, 3>::compute_inv() const
    {
        ...
        const float det_inv = (1.0) / determinant;

        inv.M[0][0] = inv00 *= det_inv;
        inv.M[0][1] = inv01 *= det_inv;
        inv.M[0][2] = inv02 *= det_inv;
        inv.M[1][0] = inv10 *= det_inv;
        inv.M[1][1] = inv11 *= det_inv;
        inv.M[1][2] = inv12 *= det_inv;
        inv.M[2][0] = inv20 *= det_inv;
        inv.M[2][1] = inv21 *= det_inv;
        inv.M[2][2] = inv22 *= det_inv;
